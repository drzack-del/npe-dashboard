...
import { createClient } from '@supabase/supabase-js';
        ...
        const generateDemoPatients = () => {
          ...
          return [
            ...
            // Historical started patients (give realistic conversion rate for benchmarks)
            p({ name: 'Chloe Martinez', phone: '(813) 555-0201', age: 13, npeDate: ago(35), location: 'Car', dp: '$750', tc: 'Reaghan', BR: true, ST: true, startDate: ago(28) }),
            p({ name: 'Derek Foster',   phone: '(813) 555-0312', age: 10, npeDate: ago(38), location: 'Apo', dp: '$500', tc: 'Katelyn', PH1: true, ST: true, startDate: ago(31) }),
            p({ name: 'Natalie Ross',   phone: '(813) 555-0445', age: 29, npeDate: ago(42), location: 'Car', dp: '$500', tc: 'Reaghan', BR: true, 'R+': true, ST: true, startDate: ago(35) }),
            p({ name: 'Caleb Price',    phone: '(813) 555-0557', age: 8,  npeDate: ago(42), location: 'Car', dp: '$0',   tc: 'Reaghan', LTD: true, ST: true, startDate: ago(36) }),
            p({ name: 'Zoe Kim',        phone: '(813) 555-0663', age: 17, npeDate: ago(45), location: 'Apo', dp: '$750', tc: 'Katelyn', BR: true, PIF: true, ST: true, startDate: ago(38) }),
            ...
            p({ name: 'Aiden Cruz',     phone: '(813) 555-0882', age: 11, npeDate: ago(50), location: 'Apo', dp: '$500', tc: 'Katelyn', BR: true, ST: true, startDate: ago(43) }),
            p({ name: 'Lily Chen',      phone: '(813) 555-0991', age: 9,  npeDate: ago(52), location: 'Car', dp: '$0',   tc: 'Reaghan', PH2: true, ST: true, startDate: ago(45) }),
            ...
            p({ name: 'Mia Scott',      phone: '(813) 555-1213', age: 12, npeDate: ago(58), location: 'Car', dp: '$500', tc: 'Reaghan', BR: true, 'W+': true, ST: true, startDate: ago(50) }),
            p({ name: 'Owen Reed',      phone: '(813) 555-1324', age: 41, npeDate: ago(60), location: 'Apo', dp: '$500', tc: 'Katelyn', INV: true, PIF: true, ST: true, startDate: ago(52) }),
            p({ name: 'Grace Bell',     phone: '(813) 555-1435', age: 14, npeDate: ago(62), location: 'Car', dp: '$750', tc: 'Reaghan', BR: true, ST: true, startDate: ago(54) }),
            p({ name: 'Finn Cooper',    phone: '(813) 555-1546', age: 7,  npeDate: ago(65), location: 'Car', dp: '$0',   tc: 'Reaghan', LTD: true, ST: true, startDate: ago(57) }),
            ...
            p({ name: 'Lucas Gray',     phone: '(813) 555-1768', age: 22, npeDate: ago(70), location: 'Car', dp: '$500', tc: 'Reaghan', BR: true, ST: true, startDate: ago(62) }),
